...
class SigCaptDialog {
  ...
  createWindow(width, height) {
    ...
    if (this.config.attachTo) {
      ...
      this.mSignatureWindow.style.height =
        height + titleBarHeight + margin + margin + "px";
      //this.mSignatureWindow.style.opacity = this.config.background.alpha;
      document
        .getElementsByTagName("body")[0]
    ...
    this.mLoadingImageDiv.innerHTML =
      '<div id="loadingDiv" style="padding-left:10px;display:table-cell;vertical-align:middle;"><table><tr><td><div class="loader"></div></td><td>Cargando la imagen, puede tomar unos segundos...</td></tr></table></div>';
    ...
    this.mGeneratingSignatureDiv.innerHTML =
      '<div id="generatingDiv" style="padding-left:10px;display:table-cell;vertical-align:middle;z-index:9"><table><tr><td><div class="loader"></div></td><td>Guardando la firma, puede tomar unos segundos</td></tr></table></div>';
  ...
  onDown(ev) {
    ...
    if (!this.willEngine) {
      this.willEngine = new Module.WillEngine(
